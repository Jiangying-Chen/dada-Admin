     ...
     <!-- <el-table-column
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <img style="width: 80px; height: 40px" :src="scope.row.img" />
        </template>
      </el-table-column>
      <el-table-column
        prop="type"
        ...
        <template slot-scope="scope">
          <div>
            <el-tag v-if="scope.row.type == 3" type="success">页面</el-tag>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div>
            <el-tag v-if="scope.row.cateId == 0" type="success">广场页</el-tag>
            <el-tag v-else type="danger">个人页</el-tag>
          </div>
        </template>
      </el-table-column>
      <el-table-column
